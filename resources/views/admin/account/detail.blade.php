    ...
    <div class="app-content">
        ...
        <section class="child-content">
            ...
            <div class="portal-form">
                <form class="form-horizontal" method="post" action="{{ url('admin/account/detail',[$user->id]) }}" id="createForm">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="control-label extend-label inline-block left">用户名 :</label>
                        <input type="text" name="name" value="{{ $user->name }}" class="form-control extend-large-input inline-block left" placeholder="请输入用户名">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="remark"  cols="30" rows="10" class="form-control extend-large-input left">{{ $user->remark }}</textarea>
                    </div>
                    <div class="form-group">
