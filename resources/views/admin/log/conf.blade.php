    ...
    <div class="app-content">
        ...
        <section class="child-content">
            ...
            <div class="common-search">
                ...
                <div class="btn-group">
                    <a href="{{ url('admin/log/conf') }}" class="btn btn-primary deepbluebg">会议详情记录</a>
                </div>
            </div>
            <div class="alert alert-success" role="alert">
                提供数据查询导出历史记录Excel
            </div>
            <form action="{{ url('admin/log/conf') }}" id="search-form" method="get" class="form-horizontal">
                {{ csrf_field() }}
                <div class="common-search">
                ...
                <div class="common-search">
                    ...
                    <div class="btn-group">
                        <a class="btn btn-primary margin-left" onclick="editUrl('{{ url('admin/log/conf') }}')" >查询</a>
                    </div>
                    <div class="btn-group margin-left">
                        <a onclick="editUrl('{{ url('admin/log/excel',['conf']) }}')" class="btn btn-primary">导出EXCEL</a>
                    </div>
                </div>
            </form>
